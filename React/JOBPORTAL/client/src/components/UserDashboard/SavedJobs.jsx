...
const SavedJobs = () => {
  ...
  const handleUnsavedJob = async (applicationId) => {
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      ...
                      {formateDate(application.appliedOn)}
                    </p>
                    <p className="text-sm text-gray-500 mt-1">
                  ...
                  <div className="ml-4 flex flex-col items-end gap-5">
                    ...
                    <div className="flex flex-col gap-5">
                      ...
                      {application.status === "saved" && (
                        <button
                          onClick={() => handleApplyJob(application._id)}
                      ...
                      {/* Unsave Button */}
                      <button
                        onClick={() => handleUnsavedJob(application._id)}
