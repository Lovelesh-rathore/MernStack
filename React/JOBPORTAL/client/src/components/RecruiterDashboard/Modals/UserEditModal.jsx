  ...
  return (
    <>
      <div id="bgContainer" className=" fixed inset-0 bg-black/50 p-30">
        <div
          id="mainContainer"
          className=" h-[80vh] w-full max-w-4xl mx-auto border bg-fuchsia-100 rounded-xl overflow-y-auto scrollbar-hide"
        >
          <div
            id="header"
            className=" flex justify-between py-5 px-10 border-b-2 sticky top-0 bg-fuchsia-200"
          >
            <h1>Edit Profile</h1>
          ...
          <div id="content" className="p-7 flex gap-20 items-center">
